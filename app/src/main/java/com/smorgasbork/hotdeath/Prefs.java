...
public class Prefs extends PreferenceActivity implements OnSharedPreferenceChangeListener {
  ...
  public static int getP1SkillLevel(Context context) {
    return Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(context)
                                             .getString(OPT_P1_SKILL_LEVEL,
                                                        OPT_P1_SKILL_LEVEL_DEF));
  }

  public static int getP1AggressionLevel(Context context) {
    return Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(context)
                                             .getString(OPT_P1_AGGRESSION_LEVEL,
                                                        OPT_P1_AGGRESSION_LEVEL_DEF));
  }

  public static int getP2SkillLevel(Context context) {
    return Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(context)
                                             .getString(OPT_P2_SKILL_LEVEL,
                                                        OPT_P2_SKILL_LEVEL_DEF));
  }

  public static int getP2AggressionLevel(Context context) {
    return Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(context)
                                             .getString(OPT_P2_AGGRESSION_LEVEL,
                                                        OPT_P2_AGGRESSION_LEVEL_DEF));
  }

  public static int getP3SkillLevel(Context context) {
    return Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(context)
                                             .getString(OPT_P3_SKILL_LEVEL,
                                                        OPT_P3_SKILL_LEVEL_DEF));
  }

  public static int getP3AggressionLevel(Context context) {
    return Integer.parseInt(PreferenceManager.getDefaultSharedPreferences(context)
                                             .getString(OPT_P3_AGGRESSION_LEVEL,
                                                        OPT_P3_AGGRESSION_LEVEL_DEF));
  }
}
